...
function init() {
    ...
    camera.position.x = cameraPositions.closed.x;
    camera.position.y = cameraPositions.closed.y;
    camera.position.z = cameraPositions.closed.z;
...
function open() {
    ...
    jackOpenAnimation.add(TweenMax.to(jack.rotation, speed / 3, {
        x: Math.random() - 0.5,
        z: Math.random() - 0.5,
        delay: jackDelay,
        ease: Power3.easeInOut
    }));
    jackOpenAnimation.add(TweenMax.to(jack.rotation, speed * 4, {
    ...
    boxOpenAnimation.add(TweenMax.to(box.position, boxBounceSpeed, {
        y: 4,
        delay: 0,
        ease: Power2.easeInOut
    }));
    boxOpenAnimation.add(TweenMax.to(box.rotation, boxBounceSpeed, {
        delay: -boxBounceSpeed,
        ease: Power2.easeOut
    }));
    boxOpenAnimation.add(TweenMax.to(box.position, boxBounceSpeed * 2, {
        y: 0,
        x: 0,
        z: 0,
        ease: Bounce.easeOut
    }));
    boxOpenAnimation.add(TweenMax.to(box.rotation, boxBounceSpeed * 2, {
        y: 0,
        x: 0,
        z: 0,
        delay: -boxBounceSpeed,
...
function close() {
    ...
    jackCloseAnimation.add(TweenMax.to(jack.rotation, 0.5, {
        x: -0.2,
        ease: Power3.easeIn
    }));
    jackCloseAnimation.add(TweenMax.to(jack.rotation, 0.8, {
        x: 0,
        z: 0,
        ease: Elastic.easeOut
    }));
